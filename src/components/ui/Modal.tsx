...
const Modal: React.FC<IModalProps> = ({
  ...
  return (
    <>
      <div
        className={cn(
          '!z-[150] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col gap-[25px] w-full py-[28px] px-[22px] rounded-sm border-r border-r-border-primary bg-foreground transition-all duration-200',
          {
            hidden: !isModalOpen,
            flex: isModalOpen,
