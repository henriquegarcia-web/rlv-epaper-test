    ...
    return (
      <div className="relative flex items-center h-10 w-full">
        <input
          type={type}
          className={cn(
            'flex h-full w-full rounded-md border border-input bg-foreground px-[14px] py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-color-legend focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
            className
          )}
          ref={ref}
          {...props}
